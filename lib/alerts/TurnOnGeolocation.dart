...
void turnOnGeolocationDialog(BuildContext context) async {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Container(
                child: AutoSizeText("Необходимо включить геолокацию \n вашего телефона", maxLines: 2, textAlign: TextAlign.center, style: new TextStyle(color: Colors.black))
              ),
            ),
            Container(
